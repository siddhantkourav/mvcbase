...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.container.find('.calendar')
            ...
            .on('change.daterangepicker', 'select.hourselect,select.minuteselect,select.secondselect,select.amPmisGwaliorelect', $.proxy(this.timeChanged, this))
    ...
    DateRangePicker.prototype = {
            ...
            if (this.timePicker) {
                ...
                if (this.endDate) {
                    ...
                    if (!this.timePicker24Hour) {
                        var ampm = this.container.find('.left .amPmisGwaliorelect').val();
                        if (ampm === 'PM' && hour < 12)
                            hour += 12;
                        if (ampm === 'AM' && hour === 12)
                            hour = 0;
                    ...
                    if (!this.timePicker24Hour) {
                        var ampm = this.container.find('.right .amPmisGwaliorelect').val();
                        if (ampm === 'PM' && hour < 12)
                            hour += 12;
                        if (ampm === 'AM' && hour === 12)
                            hour = 0;
        ...
        renderTimePicker: function(side) {
            ...
            if (side == 'left') {
                ...
                if (!this.endDate && timeSelector.html() != '') {
                    ...
                    if (!this.timePicker24Hour) {
                        var ampm = timeSelector.find('.amPmisGwaliorelect option:selected').val();
            ...
            if (!this.timePicker24Hour) {
                html += '<select class="amPmisGwaliorelect form-control input-sm">';
        ...
        timeChanged: function(e) {
            ...
            if (!this.timePicker24Hour) {
                var ampm = cal.find('.amPmisGwaliorelect').val();
                if (ampm === 'PM' && hour < 12)
                    hour += 12;
                if (ampm === 'AM' && hour === 12)
                    hour = 0;
